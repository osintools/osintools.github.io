...
const preferredFiles = [
  { file: 'src/json/username.json' },
  { file: 'src/json/email_address.json' },
  { file: 'src/json/images_videos_docs.json' },
  { file: 'src/json/telephone_numbers.json' },
  { file: 'src/json/social_networks.json' },
  { file: 'src/json/geolocation_tools_maps.json' },
  { file: 'src/json/ip_and_mac_address.json' },
  { file: 'src/json/search_engines.json' },
  { file: 'src/json/ai_tools.json' },
  { file: 'src/json/archives.json' },
  { file: 'src/json/business_records.json' },
  { file: 'src/json/classifieds.json' },
  { file: 'src/json/dark_web.json' },
  { file: 'src/json/dating.json' },
  { file: 'src/json/digital_currency.json' },
  { file: 'src/json/documentation_evidence_capture.json' },
  { file: 'src/json/domain_name.json' },
  { file: 'src/json/encoding_decoding.json' },
  { file: 'src/json/exploits_and_advisories.json' },
  { file: 'src/json/forums_blogs_irc.json' },
  { file: 'src/json/instant_messaging.json' },
  { file: 'src/json/language_translation.json' },
  { file: 'src/json/malicious_file_analysis.json' },
  { file: 'src/json/metadata.json' },
  { file: 'src/json/mobile_emulation.json' },
  { file: 'src/json/opsec.json' },
  { file: 'src/json/people_search_engines.json' },
  { file: 'src/json/public_records.json' },
  { file: 'src/json/terrorism.json' },
  { file: 'src/json/threat_intelligence.json' },
  { file: 'src/json/tools.json' },
  { file: 'src/json/training.json' },
  { file: 'src/json/transportation.json' }
]
